...
namespace boost { namespace algorithm { 
	...
	void for_each_pair(ForwardIterator begin, ForwardIterator end, Function f) {
		detail::for_each_pair_iterator(begin, end, [&f](ForwardIterator i, ForwardIterator j) { f(*i, *j); });
	}

	template <class ForwardIterator, class Function>
	void for_each_triple(ForwardIterator begin, ForwardIterator end, Function f) {
		detail::for_each_triple_iterator(begin, end, [&f](ForwardIterator i, ForwardIterator j, ForwardIterator k) { f(*i, *j, *k); });
	}

	template <class ForwardIterator, class Function>
	void for_each_quad(ForwardIterator begin, ForwardIterator end, Function f) {
	...
	size_t count_pair_if(ForwardIterator begin, ForwardIterator end, Predicate f) {
		size_t result = 0;
	...
	template <class ForwardIterator, class Predicate>
	size_t count_triple_if(ForwardIterator begin, ForwardIterator end, Predicate f) {
		size_t result = 0;
	...
	template <class ForwardIterator, class Predicate>
	size_t count_quad_if(ForwardIterator begin, ForwardIterator end, Predicate f) {
		size_t result = 0;
	...
	template <class ForwardIterator, class Predicate>
	std::pair<ForwardIterator, ForwardIterator> find_pair_if(ForwardIterator begin, ForwardIterator end, Predicate f) {
	...
	template <class ForwardIterator, class Predicate>
	std::tuple<ForwardIterator, ForwardIterator, ForwardIterator> find_triple_if(ForwardIterator begin, ForwardIterator end, Predicate f) {
	...
	template <class ForwardIterator, class Predicate>
	std::tuple<ForwardIterator, ForwardIterator, ForwardIterator, ForwardIterator> find_quad_if(ForwardIterator begin, ForwardIterator end, Predicate f) {
